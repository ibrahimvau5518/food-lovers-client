  ...
  return (
    <footer className="bg-base-200 text-base-content p-10 mt-auto">
      <div className="footer max-w-7xl mx-auto">
        <aside>
          <span className="text-2xl font-bold">🍔 Local Food Lovers</span>
          <p className="max-w-md">
            ...
            discover what others are enjoying nearby.
          </p>
        </aside>
        <nav>
      ...
      <div className="text-center mt-8 pt-8 border-t border-base-300">
        <p>
          Copyright © {new Date().getFullYear()} - Local Food Lovers Network.
          All rights reserved.
        </p>
      </div>
    </footer>
